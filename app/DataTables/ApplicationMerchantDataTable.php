        ...
        return datatables()
            ...
            ->addColumn('action', function ($application) {
                ...
                if ($application->status == 'Active') 
                    ...
                    $check = (auth()->guard('company')->user()!=null || auth('admin')->user()->can('delete_driver')) ? '<a data-href="'.url(LOGIN_USER_TYPE.'/active_merchant_application/'.$application->id).'" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#confirm-active"><i class="glyphicon glyphicon-check"></i></a>&nbsp;':'';
