...
class JotFormController extends Controller
{
    ...
    public function driver(Request $request)
    {
        ...
        $user_pic->src          =   url('jotform/' . $submissionID . '/' . $obj['temp_upload']['q131_profilephoto'][0]);
        ...
        if ($obj['temp_upload']['q134_driver_license'][0])
            $user_doc->license_front = url('jotform/' . $submissionID . '/' . $obj['temp_upload']['q134_driver_license'][0]);
        if ($obj['temp_upload']['q134_driver_license'][1])
            $user_doc->license_back = url('jotform/' . $submissionID . '/' . $obj['temp_upload']['q134_driver_license'][1]);
        $user_doc->save();
    ...
    public function merchant(Request $request, $id=null)
    {
        ...
        if ($obj['temp_upload']['q141_logo'][0])
            $application->logo = url('jotform/' . $submissionID . '/' . $obj['temp_upload']['q141_logo'][0]);
        if ($obj['temp_upload']['q147_q_photoItem'][0])
            $application->photoItem = url('jotform/' . $submissionID . '/' . $obj['temp_upload']['q147_q_photoItem'][0]);
