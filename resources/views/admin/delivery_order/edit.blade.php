		...
		<div class="row">
			...
			<div class="col-md-3 number-field">
				...
				<div class="col-md-7 col-lg-8">
                    {!! Form::hidden('customer_phone_number', @$result->customer_phone_number, ['id' => 'customer_phone_number']) !!}
					{!! Form::text('mobile_number', @$mobile_number, ['class' => 'form-control', 'id' => 'input_mobile_number', 'placeholder' => 'Phone No', 'autocomplete' => 'off']) !!}
			...
			<div class="col-md-2 form-group m-0">
				...
				{!! Form::text('first_name', @$first_name, ['class' => 'form-control', 'id' => 'input_first_name', 'placeholder' => 'First Name', 'autocomplete' => 'off']) !!}
				<span class="text-danger error_msg">{{ $errors->first('first_name') }}</span>
			</div>
			<div class="col-md-2 form-group m-0">
				{!! Form::text('last_name', @$last_name, ['class' => 'form-control', 'id' => 'input_last_name', 'placeholder' => 'Last Name', 'autocomplete' => 'off']) !!}
			...
			<div class="col-md-4 location-form">
				...
				<div class="row pick-location clearfix">
					<div class="col-md-12" ng-init='pick_up_latitude = ""'>
						...
						{!! Form::hidden('pick_up_longitude', @$result->pick_up_longitude, ['id' => 'pick_up_longitude']) !!}
						{!! Form::text('pick_up_location', @$result->pick_up_location, ['class' => 'form-control change_field', 'id' => 'input_pick_up_location', 'placeholder' => 'Pick Up Location', 'autocomplete' => 'off']) !!}
						<span class="text-danger error_msg error_pick_up_location">{{ $errors->first('pick_up_location') }}</span>
					</div>
				</div>
				<div class="row pick-location clearfix">
					<div class="col-md-12">
						{!! Form::hidden('drop_off_latitude', @$result->drop_off_latitude, ['id' => 'drop_off_latitude']) !!}
						{!! Form::hidden('drop_off_longitude', @$result->drop_off_longitude, ['id' => 'drop_off_longitude']) !!}
						{!! Form::text('drop_off_location', @$result->drop_off_location, ['class' => 'form-control change_field', 'id' => 'input_drop_off_location', 'placeholder' => 'Drop Off Location', 'autocomplete' => 'off']) !!}
				...
				<div class="row clearfix">
					<div class="col-md-12" ng-init='date_time = ""'>
						{!! Form::text('estimate_time', @$estimate_time, ['class' => 'form-control change_field', 'id' => 'input_date_time', 'placeholder' => 'Estimate time','ng-cloak']) !!}
