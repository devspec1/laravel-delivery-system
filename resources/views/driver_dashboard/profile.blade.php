...
@section('main')
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 flexbox__item four-fifths page-content" style="padding:0px !important;" ng-controller="facebook_account_kit" id="profileWrp">
  ...
  <div class="page-lead separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12 profile_update-loader" style="border-bottom:0px !important; margin-bottom: 2.5em">
    ...
    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6" style="display: flex; align-items: center">
      <label class="" style="margin-right: 0.8em;    font-weight: normal;
      font-size: 40px;">
      {{ @Auth::user()->first_name }} {{ @Auth::user()->last_name }}
    </label>
    @if(@Auth::user()->status == 'Active')
      <div class="">
        <span style="background: #5cb85; color: #fff; border: 1px solid #5cb85c;" class="label label-success"> {{ @Auth::user()->trans_status}} </span>
      </div>
    @else
      <div class="">
...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" >
  <div style="margin-bottom: 1em; display: flex; flex-direction: column">
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" style="margin-left: 5px;padding:6px 0px;">
      <input type="button" class="_style_3vhmZK" style="background-color: #3B5998; color: white; width: 8em" name="change_number" value="{{ trans('messages.profile.change') }}" id="submit-btn" ng-click="changeNumberPopup('show_popup')">
    </div>
      </div>
  </div>
</div>
...
<div class="page-lead separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: flex; border-bottom:0px !important;">
  ...
  <div style="display: flex; flex-direction: ">
      <button type="button" class="btn  doc-button" style="background: #6c757d; color: white" ng-click="selectFile()">
        <span style="padding: 0px 30px !important;font-size: 14px !important;" id="span-cls">Update Photo
        </span>
      </button>
